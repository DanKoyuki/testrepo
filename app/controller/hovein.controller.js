...
import hovein from "../models/hovein.model.js";
 ...
 const update = (req, res) => {
    try {
        const id = req.params.id;
        const {nama,email,namatempat,mesaage,rekomendasi,rating,tempatinginkunjung} = req.body;
        hovein.findByIdAndUpdate(id, {nama,email,namatempat,mesaage,rekomendasi,rating,tempatinginkunjung}, {useFindAndModify: false})
        .then(data => {
            if (!data) {
